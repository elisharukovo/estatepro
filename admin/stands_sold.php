	...
	<div class="alert alert-info"><strong>Stands Sold</strong></div>
	...
	<table class="table table-striped table-bordered">
		...
		<?php
		$query = "select * from clients,stands where clients.username=stands.username order by stands.id desc";
		...
		while($row = mysqli_fetch_array($result))
		{
			...
			if($title_deeds==""){$title_deeds="<a href='title_deeds_upload2.php?id=$id'><span class='text-danger'>Click to Upload</span></a>";}
