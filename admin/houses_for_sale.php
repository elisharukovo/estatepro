	...
	<a href="house_add.php"><button class="btn btn-success">Add New House</button></a>
							...
							<div class='listing'>
								...
								<div class='listing_content'>
									...
									<div class='listing_info'>
										...
										<a href='house_delete.php?id=<?php echo $id; ?>' title='Delete' id='$id' onclick='return confirm("Are you sure you want to delete?")'><button class='btn btn-danger'>Delete</button></a>
										<a href='house_edit.php?id=<?php echo $id; ?>' title='Edit' id='$id'><button class='btn btn-info'>Edit</button></a>
										<a href='house_add_pic.php?id=<?php echo $id; ?>' title='Add Pic' id='$id'><button class='btn btn-success'>Add Pic</button></a>
									</div>
								</div>
							</div>
						</div>
