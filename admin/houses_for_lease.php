	...
	<a href="house2_add.php"><button class="btn btn-success">Add New House for lease</button></a>
	
	<p>&nbsp;</p>
	
	<div class="alert alert-info"><Strong>Houses For Lease</strong></div>
			
<div class="listings_container">			
						  
	<?php
	$query = "select *, DATE_FORMAT(date_added, '%M %d, %Y') AS dat from houses2 where status=0 order by id desc";
							...
							<div class='listing'>
								<div class='listing_image'>
									<div class='listing_image_container'>
										<a rel='facebox' href='facebox2_view.php?id=<?php echo $id; ?>'>
										<img src='<?php echo $image ?>' alt='image' height='300'>
										</a>
									</div>
									<div class='tags d-flex flex-row align-items-start justify-content-start flex-wrap'>
										<div class='tag tag_house'><a href='#'>house</a></div>
										<div class='tag tag_sale'><a href='#'>for lease</a></div>
									</div>
									<div class='tag_price listing_price'>$ <?php echo $price; ?> / month</div>
								</div>
								<div class='listing_content'>
									...
									<div class='listing_info'>
										...
										<a href='house2_delete.php?id=<?php echo $id; ?>' title='Delete' id='$id' onclick='return confirm("Are you sure you want to delete?")'><button class='btn btn-danger'>Delete</button></a>
										<a href='house2_edit.php?id=<?php echo $id; ?>' title='Edit' id='$id'><button class='btn btn-info'>Edit</button></a>
										<a href='house2_add_pic.php?id=<?php echo $id; ?>' title='Add Pic' id='$id'><button class='btn btn-success'>Add Pic</button></a>
									</div>
								</div>
							</div>
						</div>
