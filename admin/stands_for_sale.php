	...
	<a href="stand_add.php"><button class="btn btn-success">Add New Stand</button></a>
	
	<p>&nbsp;</p>
	
	<div class="alert alert-info"><Strong>Stands For Sale</strong></div>
			
<div class="listings_container">			
						  
	<?php
	$query = "select *, DATE_FORMAT(date_added, '%M %d, %Y') AS dat from stands where status=0 order by id desc";
							...
							<div class='listing'>
								<div class='listing_image'>
									<div class='listing_image_container'>
										<a rel='facebox' href='facebox3_view.php?id=<?php echo $id; ?>'>
								...
								<div class='listing_content'>
									...
									<div class='listing_info'>
										...
										<a href='stand_delete.php?id=<?php echo $id; ?>' title='Delete' id='$id' onclick='return confirm("Are you sure you want to delete?")'><button class='btn btn-danger'>Delete</button></a>
										<a href='stand_edit.php?id=<?php echo $id; ?>' title='Edit' id='$id'><button class='btn btn-info'>Edit</button></a>
										<a href='stand_add_pic.php?id=<?php echo $id; ?>' title='Add Pic' id='$id'><button class='btn btn-success'>Add Pic</button></a>
									</div>
								</div>
							</div>
						</div>
