	...
	<div class="alert alert-info"><Strong>Add New House For Lease</strong></div>
	...
	<form action="<?php $_PHP_SELF ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
		...
		<div class="row form-group">
               <div class="col col-md-3"><label for="hf-password" class=" form-control-label">Price/ Month</label></div>
...
<?php
     ...
     $query2 = "insert into houses2(image, surburb, description, price, stand_size, toilets, rooms, garages)
	 ...
	 $query3 = "insert into images2(house_id,image_name) values('$last_id','$newname')";
     ...
     parent.location = 'houses_for_lease.php';
     </script>
     <?php
	 exit();
     }
