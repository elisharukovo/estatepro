...
<?php
     ...
     $query2 = "update houses2 set surburb='$surburb', description='$description', price='$price', stand_size='$stand_size', toilets='$toilets', rooms='$rooms', garages='$garages' where id='$_GET[id]'";
