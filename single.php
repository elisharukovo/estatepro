...
<div class="super_container">
	...
	<header class="header">
			...
			<div class="header_list">
				<ul class="d-flex flex-row align-items-center justify-content-start">
						...
						<li class="d-flex flex-row align-items-center justify-content-start">
							...
							<span>+263 786 496468</span>
						</li>

						<li class="d-flex flex-row align-items-center justify-content-start">
							<div><img src="images/phone-call.png" alt=""></div>
							<span>+263 712 913 457</span>
						</li>
						<!-- Phone -->
						<!--<li class="d-flex flex-row align-items-center justify-content-start">
							<div><img src="images/phone-call.png" alt=""></div>
							<span>+263 716 598 728</span>
						</li> -->
						<!-- Address -->
						<<li class="d-flex flex-row align-items-center justify-content-start">
							<div><img src="images/placeholder.png" alt=""></div>
							<span>Lomagundi Road, Emerald Hill, Harare</span>
						</li>
						<!-- Email -->
						<li class="d-flex flex-row align-items-center justify-content-start">
							<div><img src="images/envelope.png" alt=""></div>
							<span>elisharukovo94@gmail.com</span>
						</li>
				</ul>			
			</div>
			<div class="ml-auto d-flex flex-row align-items-center justify-content-start">
				...
				<div class="log_reg d-flex flex-row align-items-center justify-content-start">
					<ul class="d-flex flex-row align-items-start justify-content-start">
						<li><a href="https://cloud706.unlimitedwebhosting.co.uk:2096/">Login</a></li>
		...
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			<div class="logo"><span class="symbol">EstatePro</span></div>
			<nav class="main_nav">
				<ul class="d-flex flex-row align-items-start justify-content-start">
							...
							<div class="col-lg-6">
								<div class="property_info">
									...
									<div class="prop_agent d-flex flex-row align-items-center justify-content-start">
										...
										<div class="prop_agent_name"><a href="#">Elisha Rukovo,</a> Agent</div>
									</div>
									<div class="prop_info">
				...
				<div class="row">
					...
					<div class="col-xl-3 col-lg-6 footer_col">
						<div class="footer_about">
							<div class="footer_logo"><a href="#">real<span>estate</span></a></div>
							<div class="footer_text">
								<p>EstatePro sell stands to everyone. For more information you can visit us to our offices. You can also give us a call or just enter you detail on the contact page. <br> Like and follow us on Social Medias</p>
							</div>
							<div class="social">
								<ul class="d-flex flex-row align-items-center justify-content-start">
									<li><a href="https://www.linkedin.com/in/elisharukovo"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
									<li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
									<li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
									<li><a href="#"><i class="fa fa-dribbble" aria-hidden="true"></i></a></li>
									<li><a href="#"><i class="fa fa-behance" aria-hidden="true"></i></a></li>
					...
					<div class="col-xl-3 col-lg-6 footer_col">
						...
						<div class="listing_small">
							<div class="listing_small_image">
								...
								<div class="listing_small_price">Conact us now</div>
							</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Designed & Maintained </i> by <a href="www.dotport.co.zw" target="_blank">Dotport Systems</a>
</div>
