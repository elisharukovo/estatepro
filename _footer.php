				...
				<div class="row">
					...
					<div class="col-xl-3 col-lg-6 footer_col">
						<div class="footer_about">
							<div class="footer_logo"><a href="#">Properties</a></div>
							...
							<div class="social">
								<ul class="d-flex flex-row align-items-center justify-content-start">									
									...
									<li><a href="https://www.linkedin.com/in/elisharukovo" target="_target"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
							...
							<div class="footer_info">
								<ul>
									...
									<li class="d-flex flex-row align-items-center justify-content-start">
										...
										<span>Lomagundi Road, Emarald Hill, Harare</span>
									</li>
									<!-- Email -->
									<li class="d-flex flex-row align-items-center justify-content-start">
